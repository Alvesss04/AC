...
This repository contains the practical assignments and assembly code developed for the Computer Architecture course at the Faculty of Sciences and Technology of the NOVA University of Lisbon (NOVA FCT).
...
* **Documentation & Code:**
  ...
  * [Source Code (Assembly)](./src/TPC4.s)

## 🧠 Concepts and Acquired Skills
* **Low-Level Programming:** Writing, debugging, and optimizing code in Assembly language.
